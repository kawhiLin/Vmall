        ...
        <div class="col-sm-offset-2 col-md-offest-2">
            ...
            <div  class="form-horizontal">
                <div class="form-group">
                    <label for="inputEmail" class="col-sm-2 col-md-2 control-label">Username/Email</label>
                ...
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-6">
                        <button class="btn btn-lg btn-primary btn-block" type="submit" onclick="startLogin()">Sign in</button>
                    </div>
                </div>
            </div>
            <br/>
    ...
    <script type="text/javascript">
        function startLogin() {
            ...
            if(loginResult == 'success'){
                layer.msg('Success',{icon:1,"title":"INFO"});
                window.location.href = "${cp}/main";
            }
            else if(loginResult == 'unexist'){
                layer.msg('Wrong username',{icon:1,"title":"INFO"});
            }
            else if(loginResult == 'wrong'){
                layer.msg('Wrong password',{icon:1,"title":"INFO"});
            }
            else if(loginResult == 'fail'){
                layer.msg('Error',{icon:1,"title":"INFO"});
            }
