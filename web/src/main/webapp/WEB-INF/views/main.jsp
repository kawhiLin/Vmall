		...
		<div class="row">
			...
			<div class="col-sm-3 col-md-2 sidebar sidebar-1">
				<ul class="nav nav-sidebar">
					<li class="list-group-item-diy"><a href="#productArea1">手机 <span class="sr-only">(current)</span></a></li>
					<li class="list-group-item-diy"><a href="#productArea2">笔记本&平板</a></li>
					<li class="list-group-item-diy"><a href="#productArea3">智能穿戴</a></li>
					<li class="list-group-item-diy"><a href="#productArea4">智能家居</a></li>
			...
			<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
				<div class="jumbotron">
					<h1>欢迎来到VMALL</h1>
					<p>VMALL是一个的购物网站，你可以在这里模拟购买商品</p>
				</div>
